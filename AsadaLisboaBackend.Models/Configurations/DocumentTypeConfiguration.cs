    ...
    public class DocumentTypeConfiguration : IEntityTypeConfiguration<DocumentType>
    {
        public void Configure(EntityTypeBuilder<DocumentType> builder)
        {
            ...
            builder.HasData(
                ...
                new DocumentType { Id = Guid.Parse("1FA5211F-F4EA-42D1-8C5E-DEE71D9A75A7"), Name = "Word", Extension = ".doc", MimeType = "application/msword" },
                ...
                new DocumentType { Id = Guid.Parse("3F7294FC-4D1C-4A58-8576-9E2D404B2846"), Name = "Excel", Extension = ".xls", MimeType = "application/vnd.ms-excel" },
