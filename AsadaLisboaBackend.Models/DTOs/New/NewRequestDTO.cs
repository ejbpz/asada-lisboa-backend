...
namespace AsadaLisboaBackend.Models.DTOs.New
{
    public class NewRequestDTO
    {
        ...
        [MaxFileSize(5, ErrorMessage = "El tamaño máximo de imagen de la noticia es {0} MB.")] 
        [AllowedExtensions(new string[] { ".jpg", ".jpeg", ".png", ".webp", ".jfif" }, ErrorMessage = "La extensión de la imagen de la noticia no es válida.")]
