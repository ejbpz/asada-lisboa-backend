        ...
        public static List<New> Get(List<Category> categories)
        {
            ...
            return new()
            {
                ...
                new()
                {
                    ...
                    FileName = "pequeas-acciones-para-ahorrar-agua-en-casa-db88df.jpg",
                    FilePath = "noticias/pequeas-acciones-para-ahorrar-agua-en-casa-db88df.jpg",
                    StatusId = Guid.Parse("5c1cebda-fc8c-44ac-997c-aaf015572d46"),
                    Categories = new List<Category>
                    {
                        ahorro,
